...
def get_args():
    ...
    parser.add_argument('--num_clients', type=int, default=1, help='number of clinets')
    parser.add_argument('--initial_budget', type=int, default=5000, help='initial budget')
    parser.add_argument('--budget', type=int, default=5000, help='budget')
    parser.add_argument('--unlabeledbudget', type=int, default=50000, help='unlabeledbudget')
    ...
    parser.add_argument('--global_iteration1', type=int, default=1, help='global iteration')
